...
namespace warung
{
    public partial class KelolaMakanan : Form
    {
        ...
        private void Form_Pegawai_FormClosing(object sender, FormClosingEventArgs e)
        {
